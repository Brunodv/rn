...
var require_FacebookEmbed = __commonJS({
  "node_modules/react-social-media-embed/dist/components/embeds/FacebookEmbed.js"(exports) {
    ...
    var EmbedStyle_1 = require_EmbedStyle();
    var embedJsScriptSrc = "https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.2";
    ...
    var FacebookEmbed = (_a) => {
      var _b, _c;
      var { url, width, height, linkText = "View post on Facebook", placeholderImageUrl, placeholderSpinner, placeholderSpinnerDisabled = false, placeholderProps, embedPlaceholder, placeholderDisabled = false, scriptLoadDisabled = false, retryDelay = 5e3, retryDisabled = false, debug = false } = _a, divProps = __rest(_a, ["url", "width", "height", "linkText", "placeholderImageUrl", "placeholderSpinner", "placeholderSpinnerDisabled", "placeholderProps", "embedPlaceholder", "placeholderDisabled", "scriptLoadDisabled", "retryDelay", "retryDisabled", "debug"]);
      ...
      react_1.default.useEffect(() => {
        ...
        if (stage === CHECK_SCRIPT_STAGE) {
          ...
          if ((_b2 = (_a2 = win === null || win === void 0 ? void 0 : win.FB) === null || _a2 === void 0 ? void 0 : _a2.XFBML) === null || _b2 === void 0 ? void 0 : _b2.parse) {
      ...
      react_1.default.useEffect(() => {
        ...
        if (stage === PROCESS_EMBED_STAGE) {
          const win = typeof window !== "undefined" ? window : void 0;
          const parse = (_b2 = (_a2 = win === null || win === void 0 ? void 0 : win.FB) === null || _a2 === void 0 ? void 0 : _a2.XFBML) === null || _b2 === void 0 ? void 0 : _b2.parse;
          if (parse) {
            parse();
...
var require_InstagramEmbed = __commonJS({
  "node_modules/react-social-media-embed/dist/components/embeds/InstagramEmbed.js"(exports) {
    ...
    var InstagramEmbed = (_a) => {
      var _b, _c;
      var { url, width, height, linkText = "View post on Instagram", placeholderImageUrl, placeholderSpinner, placeholderSpinnerDisabled = false, placeholderProps, embedPlaceholder, placeholderDisabled = false, scriptLoadDisabled = false, retryDelay = 5e3, retryDisabled = false, igVersion = "14", debug = false } = _a, divProps = __rest(_a, ["url", "width", "height", "linkText", "placeholderImageUrl", "placeholderSpinner", "placeholderSpinnerDisabled", "placeholderProps", "embedPlaceholder", "placeholderDisabled", "scriptLoadDisabled", "retryDelay", "retryDisabled", "igVersion", "debug"]);
      ...
      React3.useEffect(() => {
        ...
        if (stage === CHECK_SCRIPT_STAGE) {
          const win = typeof window !== "undefined" ? window : void 0;
          if ((_b2 = (_a2 = win.instgrm) === null || _a2 === void 0 ? void 0 : _a2.Embeds) === null || _b2 === void 0 ? void 0 : _b2.process) {
            setStage(PROCESS_EMBED_STAGE);
          } else if (!scriptLoadDisabled) {
            setStage(LOAD_SCRIPT_STAGE);
          } else {
      ...
      React3.useEffect(() => {
        ...
        if (stage === PROCESS_EMBED_STAGE) {
          const win = typeof window !== "undefined" ? window : void 0;
          const process2 = (_b2 = (_a2 = win.instgrm) === null || _a2 === void 0 ? void 0 : _a2.Embeds) === null || _b2 === void 0 ? void 0 : _b2.process;
          if (process2) {
            process2();
            setStage(CONFIRM_EMBED_SUCCESS_STAGE);
          } else {
      ...
      return React3.createElement(
        "div",
        { className: (0, classnames_1.default)("rsme-embed rsme-instagram-embed", divProps.className), style: Object.assign({ overflow: "hidden", width: width !== null && width !== void 0 ? width : void 0, height: height !== null && height !== void 0 ? height : void 0, borderRadius }, divProps.style) },
        React3.createElement(EmbedStyle_1.EmbedStyle, null),
        React3.createElement(
          "blockquote",
          { key: embedContainerKey, className: "instagram-media", "data-instgrm-permalink": `${cleanUrlWithEndingSlash}?utm_source=ig_embed&utm_campaign=loading`, "data-instgrm-version": igVersion, style: {
            width: "calc(100% - 2px)"
          } },
...
var require_TikTokEmbed = __commonJS({
  "node_modules/react-social-media-embed/dist/components/embeds/TikTokEmbed.js"(exports) {
    ...
    var TikTokEmbed = (_a) => {
      var _b, _c;
      var { url, width, height, linkText = "View post on TikTok", placeholderImageUrl, placeholderSpinner, placeholderSpinnerDisabled = false, placeholderProps, embedPlaceholder, placeholderDisabled = false, scriptLoadDisabled = false, retryDelay = 5e3, retryDisabled = false, debug = false } = _a, divProps = __rest(_a, ["url", "width", "height", "linkText", "placeholderImageUrl", "placeholderSpinner", "placeholderSpinnerDisabled", "placeholderProps", "embedPlaceholder", "placeholderDisabled", "scriptLoadDisabled", "retryDelay", "retryDisabled", "debug"]);
      ...
      return react_1.default.createElement(
        ...
        react_1.default.createElement(
          ...
          react_1.default.createElement("blockquote", { key: embedContainerKey, className: "tiktok-embed", cite: url, "data-video-id": embedId }, !placeholderDisabled ? react_1.default.createElement("div", { id: uuidRef.current, style: { display: "flex", justifyContent: "center" } }, placeholder) : react_1.default.createElement("div", { id: uuidRef.current, style: { display: "none" } }, "\xA0"))
        )
      );
    };
  ...
  "node_modules/react-social-media-embed/dist/components/embeds/TwitterEmbed.js"(exports) {
    ...
    var TwitterEmbed = (_a) => {
      ...
      return React3.createElement(
        ...
        React3.createElement(EmbedStyle_1.EmbedStyle, null),
        React3.createElement(react_twitter_embed_1.TwitterTweetEmbed, Object.assign({ tweetId, placeholder: placeholderDisabled ? void 0 : placeholder }, twitterTweetEmbedProps))
      );
    };
...
var import_prop_types, import_react2, import_fast_deep_equal, import_youtube_player, YouTube, index_esm_default;
var init_index_esm = __esm({
  "node_modules/react-youtube/dist/index.esm.js"() {
    import_prop_types = __toESM(require_prop_types());
    import_react2 = __toESM(require_react());
    import_fast_deep_equal = __toESM(require_fast_deep_equal());
    import_youtube_player = __toESM(require_dist());
    YouTube = function(_React$Component) {
...
var require_YouTubeEmbed = __commonJS({
  "node_modules/react-social-media-embed/dist/components/embeds/YouTubeEmbed.js"(exports) {
    ...
    var classnames_1 = __importDefault(require_classnames());
    var React3 = __importStar(require_react());
    var react_youtube_1 = __importDefault((init_index_esm(), __toCommonJS(index_esm_exports)));
    var PlaceholderEmbed_1 = require_PlaceholderEmbed();
    var EmbedStyle_1 = require_EmbedStyle();
...
// dep:react-social-media-embed
var react_social_media_embed_default = require_dist2();
export {
  react_social_media_embed_default as default
};
/*
object-assign
(c) Sindre Sorhus
